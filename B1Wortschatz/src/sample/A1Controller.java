...
public class A1Controller extends General{
    ...
    @FXML
    void initialize() {
        nextButton.setOnAction(e-> update("a1Words.txt"));
    ...
    public void goToCreateCard(ActionEvent actionEvent) throws IOException {
        ...
        Pane layout = FXMLLoader.load(getClass().getResource("a1AddNewCardSample.fxml"));
